    ...
    return(
        <div className="pt-2 cursor-pointer ">
                ...
                <form class="flex items-center">
                    ...
                    <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-slate-400 rounded-lg border border-slate-400 hover:bg-slate-500 focus:ring-4 focus:outline-none focus:ring-slate-300 dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800">
